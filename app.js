...
// sets up the application with various settings and middleware, and then exports the app from the module.
...
// Lets work through the app.js file in detail. First we import some useful node libraries into the file using require(),
// including express, serve-favicon, morgan, cookie-parser and body-parser that we previously downloaded for our application
// using NPM; and path, which is a core Node library for parsing file and directory paths.
...
var mongoDB = 'mongodb://saif1642:saif1928789@ds135757.mlab.com:35757/local_library';
...
// view engine setup
// Then use app object to set up the view (template) engine. There are two parts to setting up the engine.
// First we set the 'views' value to specify the folder where the templates will be stored (in this case the sub folder /views).
...
// In addition to the 3rd party libraries we imported previously, we use the Express.
// static middleware to get Express to serve all the static files in the directory /public in the project root.
