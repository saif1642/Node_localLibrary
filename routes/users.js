...
// need to also show index.js). First it loads the express module, and uses it to get an express.
// Router object. Then it specifies a route on that object, and lastly exports the router from the module
...
// and is hence a middleware function rather than a simple route callback. While the code doesn't currently use the next argument,
// it may be useful in the future if you want to add multiple route handlers to the '/' route path.
